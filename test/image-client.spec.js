...
describe('Image Client Class Test Case', () => {
    ...
    it('test upload file success', function (done) {
        ...
        client.uploadFile('test', path.join(__dirname, 'test.jpg'))
            .then((data) => {
                done();
    ...
    it('test upload file fail', function (done) {
        ...
        client.uploadFile('test', path.join(__dirname, 'test_no_exist.jpg'))
            .then((data) => {
                done();
                assert.fail(data);
            })
    ...
    it('test idCardDetect success', function (done) {
        ...
        client.idCardDetect(path.join(__dirname, 'id_card_front.jpg'))
            .then((data) => {
                done();
